...
public final class WindowState
{
  ...
  public void setLastInputFile(final String sFileName)
  {
    lastInputFile = sFileName;
  }
  ...
  public void saveToFile(final String filename)
  {
    ...
    prop.put("input.file", (lastInputFile == null) ? "" : lastInputFile);
  ...
  public static void load(final String filename)
  {
    ...
    val = props.getProperty("input.file");
    if ((val != null) && (val.length() > 0))
    {
      ws.lastInputFile = val;
    }
